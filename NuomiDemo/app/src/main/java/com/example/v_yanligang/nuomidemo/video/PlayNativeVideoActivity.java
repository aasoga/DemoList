 ...
 */
public class PlayNativeVideoActivity extends Activity{
...
//            LogUtils.e("video", "art" + mList.get(0).displayName);
    ...
    public class Myadapter extends RecyclerView.Adapter<Myadapter.ViewHolder>{
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            if (mList.size() != 0) {
                LogUtils.e("playvideo", "size" + mList.size());
                LogUtils.e("playvideo", "size" + mList.size());
        ...
        class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                LogUtils.e("video", "position" + getLayoutPosition());
                Intent intent = new Intent(PlayNativeVideoActivity.this, NativeVideoPlayerActivity.class);
